...
export default function Chat() {
  ...
  // Effect to check authentication and initialize socket connection
  useEffect(() => {
  ...
  }, [router]); // Run this effect when the component loads
  ...
  return (
    <div className="flex flex-col h-screen bg-gray-100">
      {/* Header */}
      <header className="flex justify-between items-center bg-white p-4 shadow-md text-gray-800">
